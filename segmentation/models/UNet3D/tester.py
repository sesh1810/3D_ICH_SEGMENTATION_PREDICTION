...
args = {
    ...
    'num_gpus':1,
    'crop_size1': 138,
    'ckpt_path': '/home/mobarak/sesh/GAN_Proj/UNet/UNet_3D/ckpt/UNet3d/',
}
...
class HEMDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        _gt = glob(self.img_anno_pairs[index] + '/*__seg_resampled.nii.gz')
        ...
        _gt = torch.from_numpy(np.array(_gt)).long()
...
if __name__ == '__main__':
    #img_dir = '/home/mobarak/uu/ICH/Segmentation_ICH3d/Segmentation_Valid/**'
    img_dir = '/home/mobarak/uu/ICH/Segmentation_ICH3d/Segmentation_t2_Valid/Segmentation_Valid/**'
    #img_dir = '/home/mobarak/uu/ICH/Segmentation_ICH3d/Sesh_Valid/**'
    dataset = HEMDataset(img_dir=img_dir, transform=train_transform(p=1))
    test_loader = DataLoader(dataset=dataset, batch_size=args['batch_size'], shuffle=True, num_workers=1,drop_last=False)
    ...
    for epochs in range(1,100):
        ...
        model.load_state_dict(torch.load(os.path.join(args['ckpt_path'], args['snapshot'])))
        model.eval()
