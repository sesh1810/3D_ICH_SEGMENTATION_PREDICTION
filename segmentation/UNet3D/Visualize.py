...
for epochs in range(98, 99):
    my_model = 'ckpt/UNet3d/epoch_' + str(epochs) + '.pth.tar'
    ...
    ND_dir = glob('/home/mobarak/uu/ICH/Segmentation_ICH3d/GAN_Valid/Segmentation_Valid/9/101ct2_resampled.nii.gz')
    #ND_dir1 = glob('/home/mobarak/sesh/GAN_Proj/Registration_Final/CT_VALID_SS/101/101ct2_resampled.nii.gz')
    path = ND_dir
    #path1 = ND_dir1
    print(path)
    #print(path1)
    ...
    with torch.no_grad():
        ...
        nib.save(segmented_img,str(epochs)+'101ct1_segmented_op_zero.nii.gz')    
        #fake_b[real_b==0] = 0
